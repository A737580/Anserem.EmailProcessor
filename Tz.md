# Тестовое задание в компанию Anserem на должность "Разработчик .NET & JS"
## Описание
Email письма представляют собой набор текстовых полей: __From, To, Copy, BlindCopy, Title, Body__.
...
- __Результат выполнения необходимо залить на github и отправить ссылку на репозиторий__
- Также желательно предоставить ссылку на github-репозиторий с примерами других ваших проектов, это поможет нам лучше определить ваш уровень :)
